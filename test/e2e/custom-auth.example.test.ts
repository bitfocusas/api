...
describe('Custom Auth Example E2E', () => {
	...
	describe('Public Endpoints', () => {
		it('should access public endpoint without authentication', async () => {
			...
			const response = await supertest(app.instance.server).get('/public').expect(200)
	...
	describe('Authentication', () => {
		...
		it('should reject missing authorization header', async () => {
			...
			const response = await supertest(app.instance.server).get('/profile').expect(401)
	...
	describe('Complete Auth Flow', () => {
		it('should demonstrate complete authentication workflow', async () => {
			...
			const publicResponse = await supertest(app.instance.server).get('/public').expect(200)
			expect(publicResponse.body.message).toBe('This is a public endpoint!')

			// 2. Try protected endpoint without auth (fail)
			await supertest(app.instance.server).get('/profile').expect(401)
